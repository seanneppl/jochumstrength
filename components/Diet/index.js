...
// Need to fix duplicate weigh ins
// ex. when using "return" on mobile keyboard
...
class DietSheetPageBase extends Component {
  ...
  onSave = (e) => {
    ...
    this.props.firebase.usersDiet(this.props.uid, this.props.diet.key)
        ...
        <Row>
          ...
          <Col className="mt-3" xs={12}>
            <Form.Group as={Col} xs={12}>
              {
                alert
                  ? <Button block onClick={this.onSave} type="submit" variant="outline-success">Saved!</Button>
                  : <Button block onClick={this.onSave} type="submit" variant="outline-primary">Save</Button>
              }
            </Form.Group>
          </Col>
